...
This package helps you to better guestimate the effect of health nudges, that is, of behavioral interventions targeted at health behaviors. And make the world a *better* place! 
...
Get the effect size for behavioral interventions aka *nudges* with `better::nudge_to_behavior`. This returns an object of the `better_effect` class. It's basically a list containing the effect size, the confidence interval, and some other metadata. It's printed in a useful way.
...
```{r}
nudge_to_behavior(behavior = "health")
nudge_to_behavior(behavior = "food")
nudge_to_behavior(nudge = "assistance")
nudge_to_behavior(nudge = "structure")
nudge_to_behavior(behavior = "food", nudge = "structure")
...
```{r}
# nudge_to_behavior("information") %>% print %>%
#   behavior_cd_to_pp %>% print %>%
#   behavior_to_disease("cardiovascular disease")
# 
# nudge("information") %>%
